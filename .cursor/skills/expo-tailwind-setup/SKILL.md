...
description: Do not use in this repo (D3 — no NativeWind). Typed theme + StyleSheet.create only. Kept for reference if NativeWind is reconsidered.
version: 1.0.0
license: MIT
---
...
**Not applicable in this repo.** Decision D3 rules out NativeWind. Do not follow this skill here. Typed theme + `StyleSheet.create` only — see `docs/01-design-system.md`.
